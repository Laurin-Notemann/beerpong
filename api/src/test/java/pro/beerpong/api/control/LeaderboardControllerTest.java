...
public class LeaderboardControllerTest {
    ...
    public void leaderboard_get_invalidScope() {
        ...
        response = requestUtils.performGet(port, "/groups/" + prerequisiteGroup.getId() + "/leaderboard?scope=season&seasonId=" + prerequisiteGroup1.getActiveSeason().getId(), LeaderboardDto.class);

...
public enum ErrorCodes {
    ...
    MATCH_DTO_VALIDATION_FAILED(HttpStatus.BAD_REQUEST, "matchDtoValidationFailed", "The validation of the match create dto failed (invalid player, rulemove, season or group id, double player, or no/more than exactly one finish move)"),
    ...
    MATCH_TEAM_NOT_UNIQUE(HttpStatus.BAD_REQUEST, "matchTeamNotUnique", "The existingTeamIds have to be distinct!"),
    MATCH_TEAM_NOT_FOUND(HttpStatus.BAD_REQUEST, "matchTeamNotFound", "Could not find a team matching the provided existingTeamId!"),

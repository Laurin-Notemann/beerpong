...
public enum ErrorCodes {
    ...
    SEASON_NOT_OF_GROUP(HttpStatus.FORBIDDEN, "seasonHasDifferentGroup", "The provided season and group id do not match or no season with this id could be found!"),
